...
export default function Card({name, categories, mainImage, address, website}) {
    ...
    return(
        ...
        <div className="flex flex-col md:flex-row md:space-x-4">
          <div className="flex flex-col md:w-[45%] my-4 md:self-end">
            <div className="hidden md:block border-t-2 border-green w-full my-5" />
          ...
          <div className="flex flex-col space-y-3 align-center order-first md:order-none">
